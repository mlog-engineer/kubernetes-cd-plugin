...
public class KubernetesModelClasses extends ArrayList<Class> {
  ...
  private KubernetesModelClasses(){ 
    ...
    add(AdmissionregistrationV1ServiceReferenceBuilder.class);
    add(AdmissionregistrationV1ServiceReferenceFluent.class);
    add(AdmissionregistrationV1ServiceReferenceFluentImpl.class);
    add(AdmissionregistrationV1WebhookClientConfig.class);
    add(AdmissionregistrationV1WebhookClientConfigBuilder.class);
    add(AdmissionregistrationV1WebhookClientConfigFluent.class);
    add(AdmissionregistrationV1WebhookClientConfigFluentImpl.class);
    ...
    add(ApiextensionsV1ServiceReferenceBuilder.class);
    add(ApiextensionsV1ServiceReferenceFluent.class);
    add(ApiextensionsV1ServiceReferenceFluentImpl.class);
    add(ApiextensionsV1WebhookClientConfig.class);
    add(ApiextensionsV1WebhookClientConfigBuilder.class);
    add(ApiextensionsV1WebhookClientConfigFluent.class);
    add(ApiextensionsV1WebhookClientConfigFluentImpl.class);
    ...
    add(ApiregistrationV1ServiceReferenceBuilder.class);
    add(ApiregistrationV1ServiceReferenceFluent.class);
    add(ApiregistrationV1ServiceReferenceFluentImpl.class);
    ...
    add(V1BoundObjectReferenceBuilder.class);
    add(V1BoundObjectReferenceFluent.class);
    add(V1BoundObjectReferenceFluentImpl.class);
    ...
    add(V1CustomResourceColumnDefinitionBuilder.class);
    add(V1CustomResourceColumnDefinitionFluent.class);
    add(V1CustomResourceColumnDefinitionFluentImpl.class);
    add(V1CustomResourceConversion.class);
    add(V1CustomResourceConversionBuilder.class);
    add(V1CustomResourceConversionFluent.class);
    add(V1CustomResourceConversionFluentImpl.class);
    add(V1CustomResourceDefinition.class);
    add(V1CustomResourceDefinitionBuilder.class);
    add(V1CustomResourceDefinitionCondition.class);
    add(V1CustomResourceDefinitionConditionBuilder.class);
    add(V1CustomResourceDefinitionConditionFluent.class);
    add(V1CustomResourceDefinitionConditionFluentImpl.class);
    add(V1CustomResourceDefinitionFluent.class);
    add(V1CustomResourceDefinitionFluentImpl.class);
    add(V1CustomResourceDefinitionList.class);
    add(V1CustomResourceDefinitionListBuilder.class);
    add(V1CustomResourceDefinitionListFluent.class);
    add(V1CustomResourceDefinitionListFluentImpl.class);
    add(V1CustomResourceDefinitionNames.class);
    add(V1CustomResourceDefinitionNamesBuilder.class);
    add(V1CustomResourceDefinitionNamesFluent.class);
    add(V1CustomResourceDefinitionNamesFluentImpl.class);
    add(V1CustomResourceDefinitionSpec.class);
    add(V1CustomResourceDefinitionSpecBuilder.class);
    add(V1CustomResourceDefinitionSpecFluent.class);
    add(V1CustomResourceDefinitionSpecFluentImpl.class);
    add(V1CustomResourceDefinitionStatus.class);
    add(V1CustomResourceDefinitionStatusBuilder.class);
    add(V1CustomResourceDefinitionStatusFluent.class);
    add(V1CustomResourceDefinitionStatusFluentImpl.class);
    add(V1CustomResourceDefinitionVersion.class);
    add(V1CustomResourceDefinitionVersionBuilder.class);
    add(V1CustomResourceDefinitionVersionFluent.class);
    add(V1CustomResourceDefinitionVersionFluentImpl.class);
    add(V1CustomResourceSubresourceScale.class);
    add(V1CustomResourceSubresourceScaleBuilder.class);
    add(V1CustomResourceSubresourceScaleFluent.class);
    add(V1CustomResourceSubresourceScaleFluentImpl.class);
    add(V1CustomResourceSubresources.class);
    add(V1CustomResourceSubresourcesBuilder.class);
    add(V1CustomResourceSubresourcesFluent.class);
    add(V1CustomResourceSubresourcesFluentImpl.class);
    add(V1CustomResourceValidation.class);
    add(V1CustomResourceValidationBuilder.class);
    add(V1CustomResourceValidationFluent.class);
    add(V1CustomResourceValidationFluentImpl.class);
    ...
    add(V1EphemeralContainerBuilder.class);
    add(V1EphemeralContainerFluent.class);
    add(V1EphemeralContainerFluentImpl.class);
    add(V1Event.class);
    ...
    add(V1ExternalDocumentationBuilder.class);
    add(V1ExternalDocumentationFluent.class);
    add(V1ExternalDocumentationFluentImpl.class);
    ...
    add(V1JSONSchemaPropsBuilder.class);
    add(V1JSONSchemaPropsFluent.class);
    add(V1JSONSchemaPropsFluentImpl.class);
    add(V1Job.class);
    ...
    add(V1MutatingWebhookBuilder.class);
    add(V1MutatingWebhookConfiguration.class);
    add(V1MutatingWebhookConfigurationBuilder.class);
    add(V1MutatingWebhookConfigurationFluent.class);
    add(V1MutatingWebhookConfigurationFluentImpl.class);
    add(V1MutatingWebhookConfigurationList.class);
    add(V1MutatingWebhookConfigurationListBuilder.class);
    add(V1MutatingWebhookConfigurationListFluent.class);
    add(V1MutatingWebhookConfigurationListFluentImpl.class);
    add(V1MutatingWebhookFluent.class);
    add(V1MutatingWebhookFluentImpl.class);
    ...
    add(V1NamespaceConditionBuilder.class);
    add(V1NamespaceConditionFluent.class);
    add(V1NamespaceConditionFluentImpl.class);
    ...
    add(V1PodIP.class);
    add(V1PodIPBuilder.class);
    add(V1PodIPFluent.class);
    add(V1PodIPFluentImpl.class);
    add(V1PodList.class);
    ...
    add(V1RuleWithOperationsBuilder.class);
    add(V1RuleWithOperationsFluent.class);
    add(V1RuleWithOperationsFluentImpl.class);
    ...
    add(V1TokenRequest.class);
    add(V1TokenRequestBuilder.class);
    add(V1TokenRequestFluent.class);
    add(V1TokenRequestFluentImpl.class);
    add(V1TokenRequestSpec.class);
    add(V1TokenRequestSpecBuilder.class);
    add(V1TokenRequestSpecFluent.class);
    add(V1TokenRequestSpecFluentImpl.class);
    add(V1TokenRequestStatus.class);
    add(V1TokenRequestStatusBuilder.class);
    add(V1TokenRequestStatusFluent.class);
    add(V1TokenRequestStatusFluentImpl.class);
    ...
    add(V1TopologySpreadConstraintBuilder.class);
    add(V1TopologySpreadConstraintFluent.class);
    add(V1TopologySpreadConstraintFluentImpl.class);
    ...
    add(V1ValidatingWebhookBuilder.class);
    add(V1ValidatingWebhookConfiguration.class);
    add(V1ValidatingWebhookConfigurationBuilder.class);
    add(V1ValidatingWebhookConfigurationFluent.class);
    add(V1ValidatingWebhookConfigurationFluentImpl.class);
    add(V1ValidatingWebhookConfigurationList.class);
    add(V1ValidatingWebhookConfigurationListBuilder.class);
    add(V1ValidatingWebhookConfigurationListFluent.class);
    add(V1ValidatingWebhookConfigurationListFluentImpl.class);
    add(V1ValidatingWebhookFluent.class);
    add(V1ValidatingWebhookFluentImpl.class);
    add(V1Volume.class);
    ...
    add(V1WebhookConversionBuilder.class);
    add(V1WebhookConversionFluent.class);
    add(V1WebhookConversionFluentImpl.class);
    ...
    add(V1alpha1Endpoint.class);
    add(V1alpha1EndpointBuilder.class);
    add(V1alpha1EndpointConditions.class);
    add(V1alpha1EndpointConditionsBuilder.class);
    add(V1alpha1EndpointConditionsFluent.class);
    add(V1alpha1EndpointConditionsFluentImpl.class);
    add(V1alpha1EndpointFluent.class);
    add(V1alpha1EndpointFluentImpl.class);
    add(V1alpha1EndpointPort.class);
    add(V1alpha1EndpointPortBuilder.class);
    add(V1alpha1EndpointPortFluent.class);
    add(V1alpha1EndpointPortFluentImpl.class);
    add(V1alpha1EndpointSlice.class);
    add(V1alpha1EndpointSliceBuilder.class);
    add(V1alpha1EndpointSliceFluent.class);
    add(V1alpha1EndpointSliceFluentImpl.class);
    add(V1alpha1EndpointSliceList.class);
    add(V1alpha1EndpointSliceListBuilder.class);
    add(V1alpha1EndpointSliceListFluent.class);
    add(V1alpha1EndpointSliceListFluentImpl.class);
    add(V1alpha1Overhead.class);
    add(V1alpha1OverheadBuilder.class);
    add(V1alpha1OverheadFluent.class);
    add(V1alpha1OverheadFluentImpl.class);
    ...
    add(V1alpha1SchedulingBuilder.class);
    add(V1alpha1SchedulingFluent.class);
    add(V1alpha1SchedulingFluentImpl.class);
    ...
    add(V1beta1OverheadBuilder.class);
    add(V1beta1OverheadFluent.class);
    add(V1beta1OverheadFluentImpl.class);
    ...
    add(V1beta1SchedulingBuilder.class);
    add(V1beta1SchedulingFluent.class);
    add(V1beta1SchedulingFluentImpl.class);
    ...
    add(V1beta1VolumeNodeResourcesBuilder.class);
    add(V1beta1VolumeNodeResourcesFluent.class);
    add(V1beta1VolumeNodeResourcesFluentImpl.class);
